...
var _user = _interopRequireDefault(__webpack_require__(/*! ./user.js */ 160));
//导入购物车的vuex模块
...
var _default = {
  ...
  mutations: {
    ...
    //清除token和userInfo
    clearUserInfoAndToken: function clearUserInfoAndToken(state) {
      state.token = '';
      state.userInfo = {};
...
module.exports = function () {
  ...
  // 请求拦截
  uni.$u.http.interceptors.request.use( /*#__PURE__*/function () {
  ...
  uni.$u.http.interceptors.response.use( /*#__PURE__*/function () {
